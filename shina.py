...
def words_to_hour(text):
    ...
    mapping = {
        "дев’яти": 9, "девяти": 9, "девятої": 9,
        "десяти": 10, "десятої": 10,
        "одинадцяти": 11, "одинадцятої": 11,
        "дванадцяти": 12, "дванадцятої": 12,
        "часу": 13, "першої": 13, "одної": 13,
        "двох": 14, "другої": 14,
        "трьох": 15, "третьої": 15,
        "чотирьох": 16, "четвертої": 16,
